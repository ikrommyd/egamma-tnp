Format for the config file used for fitter:

*Note, the example plots were ran without double checks or manual fitting. Some fits did not converge and would require turning on interactive mode to fit them manually
```
   {
